...
// BuscarPublicacao traz um única publicação
...
// BuscarPublicacoesPorUsuario traz todas publicações de um usuário específico
...
// CurtirPublicacao traz todas publicações de um usuário específico
...
// DescurtirPublicacao traz todas publicações de um usuário específico
